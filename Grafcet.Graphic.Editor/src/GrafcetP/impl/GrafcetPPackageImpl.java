...
import GrafcetP.GrafcetPFactory;
import GrafcetP.GrafcetPPackage;
import GrafcetP.LocatedElement;
import GrafcetP.NamedElement;
 ...
 * @generated
 */
public class GrafcetPPackageImpl extends EPackageImpl implements GrafcetPPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see GrafcetP.GrafcetPPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GrafcetPPackageImpl() {
		super(eNS_URI, GrafcetPFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GrafcetPPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GrafcetPPackage init() {
		if (isInited) return (GrafcetPPackage)EPackage.Registry.INSTANCE.getEPackage(GrafcetPPackage.eNS_URI);

		// Obtain or create and register package
		GrafcetPPackageImpl theGrafcetPPackage = (GrafcetPPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GrafcetPPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GrafcetPPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theGrafcetPPackage.createPackageContents();

		// Initialize created meta-data
		theGrafcetPPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theGrafcetPPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GrafcetPPackage.eNS_URI, theGrafcetPPackage);
		return theGrafcetPPackage;
	}
	 ...
	 * @generated
	 */
	public GrafcetPFactory getGrafcetPFactory() {
		return (GrafcetPFactory)getEFactoryInstance();
	}
