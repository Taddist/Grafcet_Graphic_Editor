 ...
 * <!-- end-user-doc -->
 * @see GrafcetP.GrafcetPPackage
 * @generated
 */
public class GrafcetPSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static GrafcetPPackage modelPackage;
	 ...
	 * @generated
	 */
	public GrafcetPSwitch() {
		if (modelPackage == null) {
			modelPackage = GrafcetPPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GrafcetPPackage.TRANSITION: {
