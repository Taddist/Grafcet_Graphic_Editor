 ...
 * </p>
 * <ul>
 *   <li>{@link ensias.grafcet.sirius.Grafcet.impl.GrafcetImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link ensias.grafcet.sirius.Grafcet.impl.GrafcetImpl#getConnections <em>Connections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GrafcetImpl extends NamedElementImpl implements Grafcet {
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<Element>(Element.class, this, GrafcetPackage.GRAFCET__ELEMENTS, GrafcetPackage.ELEMENT__GRAFCET);
		}
		return elements;
	}
