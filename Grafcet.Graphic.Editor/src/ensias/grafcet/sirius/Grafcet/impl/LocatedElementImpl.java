 ...
 * </p>
 * <ul>
 *   <li>{@link ensias.grafcet.sirius.Grafcet.impl.LocatedElementImpl#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LocatedElementImpl extends MinimalEObjectImpl.Container implements LocatedElement {
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.LOCATED_ELEMENT__LOCATION, oldLocation, location));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GrafcetPackage.LOCATED_ELEMENT__LOCATION:
				return getLocation();
		}
